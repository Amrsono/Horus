export const ar = {
    ...
    checkout: {
        ...
        success_message: "شكراً لطلبك. تم تأمين شحنة سموكينج هاوس الخاصة بك بشكل صحيح وسيتم إرسالها قريباً.",
    ...
    footer: {
        ...
        rights: "© 2026 سموكينج هاوس. جميع الحقوق محفوظة.",
        sections: {
            shop: {
                title: "المتجر",
