                    ...
                    <div className="flex flex-col md:flex-row justify-between items-start md:items-center gap-4 border-b border-white/10 pb-6">
                        <div>
                            <h1 className="text-3xl font-bold bg-clip-text text-transparent bg-gradient-to-r from-white to-gray-400">
                                {(user?.email === 'admin@clouds.com' || user?.email === 'admin@smokinghouse.com') ? t.profile.agent_profile : t.profile.customer_profile}
                            </h1>
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
                        ...
                        <div className="glass p-6 rounded-2xl border border-white/10 space-y-6">
                            <div className="flex items-center gap-4">
                                <div className="w-20 h-20 bg-[var(--color-neon-blue)]/5 rounded-full flex items-center justify-center border border-[var(--color-neon-blue)]/20 shadow-[0_0_20px_rgba(var(--color-neon-blue-rgb),0.1)] overflow-hidden">
                                    <img src="/clouds-logo.jpg" alt="Profile" className="w-12 h-12 object-contain rounded-full" />
                                </div>
                                <div>
                                    <h2 className="font-bold text-lg">{user.user_metadata?.full_name || ((user?.email === 'admin@clouds.com' || user?.email === 'admin@smokinghouse.com') ? "Clouds Agent" : "Customer")}</h2>
